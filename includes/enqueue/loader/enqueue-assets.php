 ...
 */
if ( ! function_exists( __NAMESPACE__ . '\\enqueue_theme_assets' ) ) :
	/**
 ...
 */
if ( ! function_exists( __NAMESPACE__ . '\\enqueue_editor_ui_assets' ) ) :
	/**
...
add_action( 'enqueue_block_editor_assets', __NAMESPACE__ . '\\enqueue_editor_ui_assets' );


/**
 * Enqueue editor iframe content stylesheets
 */
if ( ! function_exists( __NAMESPACE__ . '\\enqueue_editor_styles' ) ) :
	/**
 ...
 */
if ( ! function_exists( __NAMESPACE__ . '\\enqueue_block_styles' ) ) :
	/**
	 * Enqueue individual block stylesheets
	 *
	 * @since 1.0.0
